                    ...
                    try {
                      ...
                      if (!response) {
                        toast({
                          variant: 'destructive',
                          title: 'Not Found',
                          description: 'Could not find the funnel page to delete',
                        })
                        return
                      }
                      await saveActivityLogsNotification({
                      ...
                      toast({
                        variant: 'destructive',
                        title: 'Error',
                        description: 'Failed to delete funnel page. This page may already be deleted or still has dependencies.',
                      })
                    }
                  }}
                >
